## solus Release Process

> In order to make a stable/beta release, you need to get authorization from the solus test team.

## Who can make a release?

The solus core team gives release authorization. And also have the following requirements.

- Have commit access to the solus repository.
...
Create a release action in the [Release Desktop App](https://github.com/toeverything/solus/actions/workflows/release-desktop-app.yml).
...
After the release action is completed, you can see the draft release on the [release page](https://github.com/toeverything/solus/releases).
