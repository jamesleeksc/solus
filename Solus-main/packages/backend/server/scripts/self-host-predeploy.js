...
const SELF_HOST_CONFIG_DIR = '/root/.solus/config';
/**
 * @type {Array<{ from: string; to?: string, modifier?: (content: string): string }>}
 */
const configFiles = [
  { from: './.env.example', to: '.env' },
  { from: './dist/config/solus.js', modifier: configCleaner },
  { from: './dist/config/solus.env.js', modifier: configCleaner },
];
