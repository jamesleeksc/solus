...
//
// ###############################################################
// ##                solus Configuration System                ##
// ###############################################################
// Here is the file of all solus configurations that will affect runtime behavior.
...
//   3. apply `./solus.ts` patches (this file)
//   4. apply `./solus.env.ts` patches
//
//
// ###############################################################
// ##                       General settings                    ##
...
// solus.serverId = 'some-randome-uuid';
//
// /* The name of solus Server, may show on the UI */
// solus.serverName = 'Your Cool solus Selfhosted Cloud';
//
...
solus.host = 'localhost';
// /* The local port of your server that will listen on */
solus.port = 3010;
// /* The sub path of your server */
// /* For example, if you set `solus.path = '/solus'`, then the server will be available at `${domain}/solus` */
// solus.path = '/solus';
//
//
// ###############################################################
...
// ###############################################################
//
// /* The URL of the database where most of solus server data will be stored in */
// solus.db.url = 'postgres://user:passsword@localhost:5432/solus';
//
//
// ###############################################################
...
// solus.metrics.enabled = true;
//
// /* Authentication Settings */
// /* Whether allow anyone signup */
// solus.auth.allowSignup = true;
//
...
// /* Useful when you deploy solus server in a cluster. */
...
// solus.plugins.use('aws-s3', {
//  credentials: {
//    accessKeyId: '',
//    secretAccessKey: '',
// })
// /* Update the provider of storages */
// solus.storage.storages.blob.provider = 'r2';
// solus.storage.storages.avatar.provider = 'r2';
//
// /* OAuth Plugin */
