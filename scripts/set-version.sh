...
update_app_version_in_helm_charts ".github/helm/slax/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/slax/charts/graphql/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/slax/charts/sync/Chart.yaml" "$new_version"
